      ...
      <form onSubmit={handleSubmit(handleFormSubmit)} className="needs-validation">
        ...
        <div className="row mb-3">
          <div className="col-md-6">
            <label htmlFor="nome" className="form-label">Nome do Contato</label>
            <input
              type="text"
        ...
        <div className="row mb-3">
          <div className="col-md-6">
            ...
            <input
              type="text"
              className={`form-select ${errors.telefone ? 'is-invalid' : ''}`}
              id="telefone"
          ...
          <div className="col-md-6">
            <label htmlFor="secretaria" className="form-label">Secretaria</label>
            <select
              className={`form-select ${errors.secretaria ? 'is-invalid' : ''}`}
              id="secretaria"
            ...
            >
              ...
              {secretarias.map(secretaria => (
                <option key={secretaria.id} value={secretaria.id}>
                  {secretaria.nome} - {secretaria.secretaria} Mbps - {secretaria.link}
                </option>
              ))}
            </select>
