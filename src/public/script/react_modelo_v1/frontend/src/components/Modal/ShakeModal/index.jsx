// C:\laragon\www\sgcpro\src\public\script\react_modelo_v1\frontend\src\components\Modal\shakeModal\index.jsx
import React, { useState, useEffect } from 'react';
import './style.css';

const ModalShake = ({ idModal, buttonName, strTitleModal, children, isOpenInitial = false }) => {
    ...
    return (
        <div>
            ...
            {/* Modal */}
            {activeModal === idModal && (
                <div className="modal-overlay-shake">
                    <div className="modal-custom-shake m-4 p-3">
