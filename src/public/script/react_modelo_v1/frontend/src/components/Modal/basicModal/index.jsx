// C:\laragon\www\sgcpro\src\public\script\react_modelo_v1\frontend\src\components\Modal\basicModal\index.jsx
import React, { useState, useEffect } from 'react';
import './style.css';

const ModalBasic = ({ idModal, buttonName, strTitleModal, children, isOpenInitial = false }) => {
        ...
        <div>
            ...
            {activeModal === idModal && (
                <div className="modal-overlay">
                    <div className="modal-custom m-4 p-3">
