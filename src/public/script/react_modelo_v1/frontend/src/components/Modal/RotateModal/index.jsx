// C:\laragon\www\sgcpro\src\public\script\react_modelo_v1\frontend\src\components\Modal\rotateModal\index.jsx
import React, { useState, useEffect } from 'react';
import './style.css';

const ModalRotate = ({ idModal, buttonName, strTitleModal, children, isOpenInitial = false }) => {
    ...
    return (
        <div>
            ...
            {/* Modal */}
            {activeModal === idModal && (
                <div className="modal-overlay-rotate">
                    <div className="modal-custom-rotate m-4 p-3">
