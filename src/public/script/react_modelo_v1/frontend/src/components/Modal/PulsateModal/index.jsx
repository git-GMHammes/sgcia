// C:\laragon\www\sgcpro\src\public\script\react_modelo_v1\frontend\src\components\Modal\pulsateModal\index.jsx
import React, { useState, useEffect } from 'react';
import './style.css';

const ModalPulsate = ({ idModal, buttonName, strTitleModal, children, isOpenInitial = false }) => {
    ...
    return (
        <div>
            ...
            {/* Modal */}
            {activeModal === idModal && (
                <div className="modal-overlay-pulsate">
                    <div className="modal-custom-pulsate m-4 p-3">
