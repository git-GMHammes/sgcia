// C:\laragon\www\sgcpro\src\public\script\react_modelo_v1\frontend\src\components\Modal\elasticModal\index.jsx
import React, { useState, useEffect } from 'react';
import './style.css';

const ElasticModal = ({ idModal, buttonName, strTitleModal, children, isOpenInitial = false }) => {
    ...
    return (
        <div>
            ...
            {/* Modal */}
            {activeModal === idModal && (
                <div className="modal-overlay-elastic">
                    <div className="modal-custom-elastic m-4 p-3">
