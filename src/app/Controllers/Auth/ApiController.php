...
class ApiController extends ResourceController
{
    ...
    # route POST /# www/index.php/sgcpro/Autenticar/api/react/(:any)
    # route GET /# www/index.php/sgcpro/Autenticar/api/react/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    public function AuthReact()
    {
        ...
        try {
            #
            $apiRespond = $this->setApiRespond('success', $getMethod, $varSession);
            $response = $this->response->setStatusCode(201)->setJSON($apiRespond);
            #
        } catch (\Exception $e) {
            $apiRespond = $this->setApiRespond('error', $getMethod, $varSession, $e->getMessage());
