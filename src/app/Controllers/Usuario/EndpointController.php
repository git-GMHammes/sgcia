...
class EndpointController extends ResourceController
{
    ...
    # route POST /www/index.php/sgcpro/usuario/endpoint/listar/(:any)
    # route GET /www/index.php/sgcpro/usuario/endpoint/listar/(:any)
    # Informação sobre o controller
    # retorno do controller [view]
    public function dbRead()
    {
        // C:\laragon\www\sgcpro\src\app\Controllers\Usuario\EndpointController.php
