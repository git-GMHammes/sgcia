...
class ApiController extends ResourceController
{
    ...
    # route POST www/index.php/sgcpro/user/api/cadastrar/(:any)
    # route GET www/index.php/sgcpro/user/api/cadastrar/(:any)
    # route POST www/index.php/sgcpro/user/api/atualizar/(:any)
    # route GET www/index.php/sgcpro/user/api/atualizar/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    ...
    # route POST www/index.php/sgcpro/user/api/listar/(:any)
    # route GET www/index.php/sgcpro/user/api/listar/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    ...
    # route POST www/index.php/sgcpro/user/api/filtrar/(:any)
    # route GET www/index.php/sgcpro/user/api/filtrar/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    ...
    # route POST www/index.php/sgcpro/user/api/deletar/(:any)
    # route GET www/index.php/sgcpro/user/api/deletar/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    ...
    # route POST www/index.php/sgcpro/user/api/limpar/(:any)
    # route GET www/index.php/sgcpro/user/api/limpar/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    ...
    # route POST /www/index.php/sgcpro/usuario/api/teste/(:any)
    # route GET /www/index.php/sgcpro/usuario/api/teste/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    public function testeUsuario($parameter = NULL)
    {
        ...
        $montaJSON = $this->setApiRespond('success', 'GET', $varSession);
