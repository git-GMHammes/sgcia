...
# 
use App\Controllers\Telefone\DbController; // Ensure this path is correct and the class exists
...
class ApiController extends ResourceController
{
    ...
    # route POST www/index.php/sgcpro/secretaria/api/cadastrar/(:any)
    # route GET www/index.php/sgcpro/secretaria/api/cadastrar/(:any)
    # route POST www/index.php/sgcpro/secretaria/api/atualizar/(:any)
    # route GET www/index.php/sgcpro/secretaria/api/atualizar/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    ...
    # route POST www/index.php/sgcpro/secretaria/api/listar/(:any)
    # route GET www/index.php/sgcpro/secretaria/api/listar/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    ...
    # route POST www/index.php/sgcpro/secretaria/api/filtrar/(:any)
    # route GET www/index.php/sgcpro/secretaria/api/filtrar/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    ...
    # route POST www/index.php/sgcpro/secretaria/api/deletar/(:any)
    # route GET www/index.php/sgcpro/secretaria/api/deletar/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    ...
    # route POST www/index.php/sgcpro/secretaria/api/limpar/(:any)
    # route GET www/index.php/sgcpro/secretaria/api/limpar/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
