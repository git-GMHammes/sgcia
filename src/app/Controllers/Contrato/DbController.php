...
class DbController extends BaseController
{
    ...
    public function dbFields($processRequestFields = array())
    {
        ...
        $dbCreate = array();
        $autoColumn = $this->ModelContrato->getColumnsFromTable();
    ...
    public function dbCreate($parameter = NULL)
    {
        ...
        try {
            $this->ModelContrato->dbCreate($this->dbFields($parameter));
            $affectedRows = $this->ModelContrato->affectedRows();
            if ($affectedRows > 0) {
                $dbCreate['insertID'] = $this->ModelContrato->insertID();
    ...
    public function dbUpdate($key, $parameter = NULL)
    {
        if (
            ...
            $this->ModelContrato->dbUpdate($key, $parameter);
        } else {
            $this->ModelContrato->dbUpdate($key, $this->dbFields($parameter));
        }
        try {
            $affectedRows = $this->ModelContrato->affectedRows();
            if ($affectedRows > 0) {
    ...
    {
        try {
            $this->ModelContrato->dbDelete('id', $parameter);
            $affectedRows = $this->ModelContrato->affectedRows();
            if ($affectedRows > 0) {
