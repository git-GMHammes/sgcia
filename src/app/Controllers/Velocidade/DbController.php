...
use App\Models\VelocidadeModel;
...
class DbController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->ModelVelocidade = new VelocidadeModel();
    ...
    public function dbFields($processRequestFields = array())
    {
        ...
        $dbCreate = array();
        $autoColumn = $this->ModelVelocidade->getColumnsFromTable();
    ...
    public function dbCreate($parameter = NULL)
    {
        ...
        try {
            $this->ModelVelocidade->dbCreate($this->dbFields($parameter));
            $affectedRows = $this->ModelVelocidade->affectedRows();
            if ($affectedRows > 0) {
                $dbCreate['insertID'] = $this->ModelVelocidade->insertID();
    ...
    public function dbUpdate($key, $parameter = NULL)
    {
        if (
            ...
            $this->ModelVelocidade->dbUpdate($key, $parameter);
        } else {
            $this->ModelVelocidade->dbUpdate($key, $this->dbFields($parameter));
        }
        try {
            $affectedRows = $this->ModelVelocidade->affectedRows();
            if ($affectedRows > 0) {
    ...
    {
        try {
            $this->ModelVelocidade->dbDelete('id', $parameter);
            $affectedRows = $this->ModelVelocidade->affectedRows();
            if ($affectedRows > 0) {
