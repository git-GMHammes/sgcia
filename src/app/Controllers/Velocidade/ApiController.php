<?php
#
namespace App\Controllers\Velocidade;

use CodeIgniter\RESTful\ResourceController;
use CodeIgniter\API\ResponseTrait;
# 
use App\Controllers\Velocidade\DbController;
...
class ApiController extends ResourceController
{
    ...
    # route POST www/index.php/sgcpro/velocidade/api/cadastrar/(:any)
    # route GET www/index.php/sgcpro/velocidade/api/cadastrar/(:any)
    # route POST www/index.php/sgcpro/velocidade/api/atualizar/(:any)
    # route GET www/index.php/sgcpro/velocidade/api/atualizar/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    public function create_update($parameter = NULL)
    {
        ...
        // myPrint($processRequest, 'C:\Velocidades\Habilidade.Com\AppData\Roaming\Code\Velocidade\snippets\php.json');
        #
        if ($getMethod == 'GET') {
            $request = service('request');
            $apiRespond['getMethod'] = $request->getMethod();
    ...
    # route POST www/index.php/sgcpro/velocidade/api/listar/(:any)
    # route GET www/index.php/sgcpro/velocidade/api/listar/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    public function dbRead($parameter = NULL)
    {
        ...
        #
        // myPrint($getMethod, 'C:\Velocidades\Habilidade.Com\AppData\Roaming\Code\Velocidade\snippets\php.json');
        try {
            #
    ...
    # route POST www/index.php/sgcpro/velocidade/api/filtrar/(:any)
    # route GET www/index.php/sgcpro/velocidade/api/filtrar/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    public function dbFilter($parameter = NULL)
    {
        ...
        try {
            ...
            // exit('EXIT_src\app\Controllers\Velocidade\ApiController.php');
            #
            $apiRespond = $this->setApiRespond('success', $getMethod, $requestDb);
            $response = $this->response->setStatusCode(201)->setJSON($apiRespond);
        } catch (\Exception $e) {
    ...
    # route POST www/index.php/sgcpro/velocidade/api/deletar/(:any)
    # route GET www/index.php/sgcpro/velocidade/api/deletar/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    public function dbDelete($parameter1 = NULL, $parameter2 = NULL)
    {
        ...
        try {
            ...
            if (
                ...
                // myPrint($parameter1, 'C:\Velocidades\Habilidade.Com\AppData\Roaming\Code\Velocidade\snippets\php.json', true);
                #
    ...
    # route POST www/index.php/sgcpro/velocidade/api/limpar/(:any)
    # route GET www/index.php/sgcpro/velocidade/api/limpar/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
