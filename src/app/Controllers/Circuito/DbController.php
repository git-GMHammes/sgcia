...
use App\Models\ViewCircuitoVelocidadeModel;
use Exception;

class DbController extends BaseController
{
    // private $ModelUpload;
    private $ModelCircuito;
    private $ModelViewCircuitoVelocidade;
    private $message;
    private $uri;
    private $pagination;
    ...
    public function __construct()
    {
        ...
        $this->ModelViewCircuitoVelocidade = new ViewCircuitoVelocidadeModel();
        $this->ModelCircuito = new CircuitoModel();
    ...
    public function dbFields($processRequestFields = array())
    {
        ...
        $dbCreate = array();
        $autoColumn = $this->ModelCircuito->getColumnsFromTable();
    ...
    public function dbFieldsFilter($processRequestFields = array())
    {
        ...
        $dbCreate = array();
        $autoColumn = $this->ModelViewCircuitoVelocidade->getColumnsFromTable();
    ...
    public function dbCreate($parameter = NULL)
    {
        ...
        try {
            $this->ModelCircuito->dbCreate($this->dbFields($parameter));
            $affectedRows = $this->ModelCircuito->affectedRows();
            if ($affectedRows > 0) {
                $dbCreate['insertID'] = $this->ModelCircuito->insertID();
    ...
    public function dbUpdate($key, $parameter = NULL)
    {
        if (
            ...
            $this->ModelCircuito->dbUpdate($key, $parameter);
        } else {
            $this->ModelCircuito->dbUpdate($key, $this->dbFields($parameter));
        }
        // myPrint('$parameter :: ', $parameter, true);
        try {
            $affectedRows = $this->ModelCircuito->affectedRows();
    ...
    {
        try {
            $this->ModelCircuito->dbDelete('id', $parameter);
            $affectedRows = $this->ModelCircuito->affectedRows();
            if ($affectedRows > 0) {
