    ...
    function myEndPoint($uri = NULL, $token = '123')
    {
        ...
        try {
            if($_SERVER['SERVER_NAME'] == '127.0.0.1'){
                $base = $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['SERVER_NAME'] . ':80' . '/';
            }else{
                $base = $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['SERVER_NAME'] . ':' . $_SERVER["SERVER_PORT"] . '/src/public/';
            }
            $myEndPoint = $base . $uri;
            // myPrint($myEndPoint, 'C:\Users\Dev\AppData\Local\Temp\fz3temp-2\myEndPoint_helper.php');
